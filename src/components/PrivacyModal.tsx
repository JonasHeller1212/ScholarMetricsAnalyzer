        ...
        <div className="p-6 space-y-6">
          <section>
            ...
            <p className="text-gray-600 mb-4">
              Scholar Metrics Analyzer collects and processes only the publicly available data from Google Scholar profiles. We do not store any personal information beyond what is necessary for the application's functionality.
            </p>
